...
namespace MidiPlayerTK
{
    ...
    {
        public static void EffectSoundFontParametersFilter(MidiSynth instance, CustomStyle myStyle)
        {
        ...
        public static void EffectSoundFontParametersReverb(MidiSynth instance, CustomStyle myStyle)
        {
            EditorGUI.indentLevel++;
        ...
        public static void EffectSoundFontParametersChorus(MidiSynth instance, CustomStyle myStyle)
        {
            EditorGUI.indentLevel++;
#if MPTK_PRO && UNITY_ANDROID && UNITY_OBOE
                EditorGUILayout.LabelField("Applying this effect with Oboe can cause weird sounds or even crash some devices", myStyle.LabelAlert);
        ...
        public static void EffectUnityParameters(MidiSynth instance, CustomStyle myStyle)
        {
            ...
            instance.MPTK_EffectUnity.EnableReverb = false;
            instance.MPTK_EffectUnity.EnableChorus = false;  
#endif
