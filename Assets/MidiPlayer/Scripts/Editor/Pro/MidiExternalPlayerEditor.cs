    ...
    public class MidiExternalPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                commonEditor.DrawCaption(instance, "Midi External Player - Play from MIDI outside the MIDI DB.", "https://paxstellar.fr/midi-external-player-v2/", "d8/dc5/class_midi_player_t_k_1_1_midi_external_player.html#details");
