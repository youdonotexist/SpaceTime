    ...
    public class MidiListPlayerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            try
            {
                ...
                commonEditor.DrawCaption(null, "Midi List Player - Play from a list of MIDI.", "https://paxstellar.fr/midi-list-player-v2/", "dd/d3d/class_midi_player_t_k_1_1_midi_list_player.html#details");
        ...
        {
            float volume = EditorGUILayout.Slider(new GUIContent("Volume", "Set global volume"), instance.MPTK_Volume, 0f,Constant.MAX_VOLUME);
